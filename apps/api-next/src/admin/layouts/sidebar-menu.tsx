...
export const AdminSidebarMenu = observer(function AdminSidebarMenu() {
  ...
  const handleItemClick = () => {
    if (window.innerWidth < 768) toggleSidebar(!isSidebarCollapsed);
  };
              ...
              <Tooltip tooltipContent={item.name} position="right" className="ml-2" disabled={!isSidebarCollapsed}>
                <div
                  className={cn(
                    ...
                    { "text-primary !bg-layer-transparent-active": isActive, "text-secondary hover:bg-layer-transparent-hover active:bg-layer-transparent-active": !isActive },
