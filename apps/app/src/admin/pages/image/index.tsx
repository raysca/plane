...
function InstanceImageConfigForm({ config }: { config: IFormattedInstanceConfiguration }) {
  ...
  const onSubmit = async (formData: ImageConfigFormValues) => {
    ...
    await updateInstanceConfigurations(payload)
      .then(() => setToast({ type: TOAST_TYPE.SUCCESS, title: "Success", message: "Image Configuration Settings updated successfully" }))
        ...
        <ControllerInput
          ...
          description={
            <>
              ...
              <a href="https://unsplash.com/documentation#creating-a-developer-account" target="_blank" className="text-accent-primary hover:underline" rel="noreferrer">
                Learn more.
              </a>
            </>
          }
...
const InstanceImagePage = observer(function InstanceImagePage() {
