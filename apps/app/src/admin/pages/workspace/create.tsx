      ...
      .then(async (res) => {
        if (res.status === true && !RESTRICTED_URLS.includes(formData.slug)) {
          ...
          await createWorkspace(formData)
            ...
            .catch(() => {
              setToast({ type: TOAST_TYPE.ERROR, title: "Error!", message: "Workspace could not be created. Please try again." });
            });
        } else setSlugError(true);
      })
      .catch(() => {
        setToast({ type: TOAST_TYPE.ERROR, title: "Error!", message: "Some error occurred while creating workspace. Please try again." });
      });
  };
  ...
  return (
    <div className="space-y-8">
              ...
              render={({ field: { value, ref, onChange } }) => (
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    setValue("slug", e.target.value.toLocaleLowerCase().trim().replace(/ /g, "-"), { shouldValidate: true });
                  }}
                  ref={ref}
          ...
          <div className="flex gap-0.5 w-full items-center rounded-md border-[0.5px] border-subtle px-3">
            ...
            <Controller
              ...
              rules={{
                ...
                maxLength: { value: 48, message: "Limit your URL to 48 characters." },
              }}
      ...
      <div className="flex max-w-4xl items-center py-1 gap-4">
        ...
        <Link className={getButtonStyling("secondary", "lg")} to="/workspace">
          Go back
        </Link>
      </div>
    </div>
