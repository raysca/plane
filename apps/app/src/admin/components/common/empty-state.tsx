...
type Props = {
  ...
  image?: string;
  primaryButton?: { icon?: any; text: string; onClick: () => void };
    ...
    <div className="flex h-full w-full items-center justify-center">
      <div className="flex w-full flex-col items-center text-center">
        ...
        <div className="flex items-center gap-4">
          {primaryButton && (
            <Button variant="primary" prependIcon={primaryButton.icon} onClick={primaryButton.onClick} disabled={disabled} size="lg">
              {primaryButton.text}
            </Button>
          )}
          {secondaryButton}
